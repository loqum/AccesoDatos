...
public class SuperGuerreroDto extends SuperEspecieDto {
  ...
  /**
   * Constructor del objeto SuperGuerreroDto.
   * @param idSuperEspecie
   *  ID del objeto SuperEspecieDto del cual extiende.
   * @param nombre
   *  Nombre del objeto SuperGuerreroDto.
   * @param idSuperGuerrero
   *  ID del objeto SuperGuerreroDto.
   * @param descripcion
   *  Descripcion del objeto SuperGuerreroDto.
   * @param tipoPoder
   *  Tipo de poder del objeto SuperGuerreroDto.
   * @param nivelPoder
   *  Nivel de poder del objeto SuperGuerreroDto.
   *      Hace referencia al Tipo de Poder.
   */
  
  public SuperGuerreroDto(long idSuperEspecie, String nombre, 
      long idSuperGuerrero, String descripcion, String tipoPoder, int nivelPoder) {
