...
public class ConnectionDataBase {
  ...
  private static final Logger LOGGER = 
      Logger.getLogger(com.rfm.utils.ConnectionDataBase.class.getName());
  ...
  /**
   * Devuelve la instancia para llamar al metodo ConnectionDataBase.
   * @return
   * Devuelve una ConnectionDataBase.
   */
