...
public class Literales {
	...
	private static final String INTRODUCE_TIPO_ESPECIE = "¿A que Super Especie quieres que pertenezca este Super Guerrero? Introduce el Id: ";
	...
	private static final String INTRODUCE_ID_SUPERESPECIE = "Selecciona por su número de ID la Super Especie que quieres borrar: ";
	private static final String INTRODUCE_ID_RESET_SUPERGUERRERO = "Selecciona por su número de ID el Super Guerrero al que quieres resetear su poder: ";
	private static final String INTRODUCE_ID_UPDATE_SUPERGUERRERO = "Selecciona por su número de ID el Super Guerrero al que quieres actualizar su poder: ";
	...
	private static final String ERROR_NO_SUPERGUERRERO = "No hay ningun Super Guerrero";
	...
	private static final String UPDATE_PODER = "UPDATE superguerrero SET tipopoder=(?), nivelpoder=(?) WHERE idsuperguerrero=(?)";
	private static final String SELECT_SUPERGUERRERO = "SELECT * FROM superguerrero";
	private static final String RESET_PODER_SUPERGUERRERO = "UPDATE superguerrero SET tipopoder = null, nivelpoder = null WHERE idsuperguerrero=(?);";
	...
	private static final String OUTPUT_FORMAT_SUPERGUERRERO = "Super Guerrero #%d:\n\t · ID SuperEspecie: %d · Nombre: %s · Descripcion: %s · Tipo de poder: %s · Nivel de poder: %d";
	private static final String OUTPUT_FORMAT_SUPERESPECIE = "Super Especie #%d: \n\t· Nombre: %s";

	private static final String DESCRIPCION_SUPERGUERRERO = "descripcion";
	private static final String NOMBRE = "nombre";
	private static final String TIPO_PODER_SUPERGUERRERO = "tipopoder";
	private static final String NIVEL_PODER_SUPERGUERRERO = "nivelpoder";
	private static final String ID_SUPERGUERRERO = "idsuperguerrero";
	private static final String ID_SUPERESPECIE = "idsuperespecie";
	...
	private static final StringBuilder BIENVENIDA_PROGRAMA = builderBienvenidaPrograma.append(ESQUELETO_VERTICAL)
			...
			.append("*	3: Consultar Super Especie						*").append("\n")
			.append("*	4: Consultar Super Guerrero						*").append("\n")
			.append("*	5: Añadir poder a Super Guerrero					*").append("\n")
			.append("*	6: Resetear poderes de Super Guerrero		  			*").append("\n")
			.append("*	7: Eliminar Super Guerrero						*").append("\n")
			.append("*	8: Eliminar Super Especie						*").append("\n")
			.append("*	9: Ver instrucciones							*").append(ESQUELETO_LATERAL)
