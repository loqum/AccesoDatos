...
public class Consola {
  ...
  /**Esta clase llama al metodo de acceso a BD correspondiente en funcion de la entrada por consola.
   * @throws SQLException
   * Puede lanzar una SQLException como resultado de algun problema de conexion 
   */
